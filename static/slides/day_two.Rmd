...
#### You really don't want to use the terminal ❓ ▶ For version control in RStudio, see [here](https://support.rstudio.com/hc/en-us/articles/200532077-Version-Control-with-Git-and-SVN), and particularly [**this video**](https://www.youtube.com/watch?v=megZYkCLMA4)
---
...
.blue-h[`git commit -m "add empty readme"`] stages all content to be pushed 
...
# .fat[.fancy[Integrating osf with GitHub]]

<img src="img/osf.png" width="200px"/> 
---
class: middle, inverse

## .fancy[Integrating osf with GitHub]

### 1. Create your osf project 
### 2. Enable GitHub in Add-ons

<img src="img/osf_int.png" width="500px"/>
...
<img src="img/osf_imp.png" width="500px"/>
...
<img src="img/osf_sel.png" width="500px"/>
...
### Major resources: [Alison Hill and Yihui Xie's Advanced R Workshop](https://github.com/rstudio-education/arm-workshop-rsc2019)
---
...
<img src="img/blog_proj.png" width="200px"/>

2) Make a [repo on <i class="fab fa-github fa-lg fa-fw"></i>GitHub](https://happygitwithr.com/new-github-first.html#make-a-repo-on-github-1)
...
4) Serve site  
  <img src="img/serve.png" width="200px"/>
...
## .fancy[Choose your theme]

See [here](https://themes.gohugo.io) for a collection of Hugo themes. 
...
2. Move the configuration file (config.yaml or config.toml) from the themes/theme-name/exampleSite/ directory to the root directory of your website to match the newly installed theme.

3. Carefully inspect the differences between your new theme’s exampleSite and the files inside your content/ folder. A theme’s exampleSite content is tailored to a specific theme.
]
...
# `r emo::ji("earth_africa")` Setting global options in .Rprofile
...
options(blogdown.author = "Author Name",
        ...
        blogdown.new_bundle = TRUE, # created index.md file (using bundles - storing files related to post in post folder)
...
- [Blog post](https://alison.rbind.io/post/up-and-running-with-blogdown/)
- [Blogdown workshop](https://alison.rbind.io/talk/blogdown-meetup/)
...
1. Create a new blogdown project with the theme of your choice (follow the workflow described [here](https://bookdown.org/yihui/blogdown/other-themes.html#new-site-new-theme))
...
# .fat[.fancy[Other useful R tools]] 🌟
...
include_graphics("img/xaringan.png")
```

See [here](https://bookdown.org/yihui/rmarkdown/xaringan.html) for more info.
---
...
```{r echo = FALSE, out.width='60%'}
include_graphics("img/bookdown.png")
```
...
# .fat[.fancy[Shiny applications]] 

```{r echo = FALSE, out.width='70%'}
include_graphics("img/shiny.png")
```

See [here](https://shiny.rstudio.com/) for more info
